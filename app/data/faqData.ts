/**
 * FAQ Data - Centralized for SEO Optimization
 *
 * This file contains all FAQ data used across:
 * - FAQ page (/faqs/page.tsx)
 * - Sitemap generation (automatic individual URLs)
 * - Schema.org structured data (FAQPage markup)
 * - Internal linking from blog posts
 *
 * SEO FEATURES:
 * ✅ Server-side rendered for better indexing
 * ✅ Each FAQ has unique URL (/faqs#faq-0, /faqs#faq-1, etc.)
 * ✅ Included in sitemap.xml with proper priority
 * ✅ FAQPage schema markup (HTML auto-stripped)
 * ✅ Enhanced metadata for search engines
 * ✅ Easy internal linking from other pages
 *
 * TO ADD A NEW FAQ:
 * 1. Add object to faqItems array below
 * 2. Include category, question, answer
 * 3. Optionally mark as popular
 * 4. Optionally link to related FAQs
 * 5. Sitemap and schema update automatically!
 *
 * TO LINK TO FAQ FROM OTHER PAGES:
 * import FAQReference from '@/app/components/FAQReference';
 * <FAQReference index={5} variant="callout" />
 */
...
export interface FAQItem {
  ...
  answer: string;
  category: string;
  popular?: boolean; // Shows in "Most Popular" section, higher priority in sitemap
  relatedIndexes?: number[]; // Array of FAQ indexes to link as related questions
}
...
},
{
  ...
  answer: "<strong>[NY]</strong> My fee for LLC formation is $1,250. Please note that <a href='https://dos.ny.gov/division-corporations' target='_blank' rel='noopener noreferrer'>New York has a publishing requirement when forming an LLC</a> (NY Department of State), which can cost more than $1,000 on top of my fee. Connecticut does not have this requirement, so if you're considering a CT LLC that will operate in NY, I'd recommend discussing the pros and cons with your tax preparer first. There may be significant differences in the tax ramifications between the two states."
},
...
// BUYING A HOME
{
  ...
  question: "When should I hire a real estate lawyer as a home buyer?",
  answer: "It is best to hire a real estate lawyer as soon as your offer is accepted or even before you sign a contract. I can review and negotiate your contract, explain your rights and obligations, and help you avoid terms that may create problems later in the process.",
  popular: true
},
{
  category: "Buying a Home",
  question: "What does a real estate lawyer do for a home buyer?",
  answer: "As your lawyer, I review and negotiate your contract, coordinate with your real estate agent and lender, review the title report, address issues that arise from inspections, and represent you at closing so you understand what you are signing and what happens next.",
  popular: true
},
{
  category: "Buying a Home",
  question: "How long does a typical Staten Island real estate closing take?",
  answer: "While every transaction is different, a typical residential closing in Staten Island may take anywhere from 45 to 90 days from contract to closing, depending on financing, inspections, title issues, and other factors.",
  popular: true
},
{
  category: "Buying a Home",
  question: "Do I need a real estate attorney to buy a home?",
  answer: "<strong>[NY]</strong> New York doesn't technically require you to hire an attorney, but it's customary and I strongly recommend it. I negotiate your contract, review title and building documents, address issues that come up, and represent you at closing. <strong>[NJ]</strong> In New Jersey, attorney involvement is also standard and recommended.<br><br><strong>Learn more:</strong> <a href='/blog/why-you-need-attorney-buying-selling-property'>Why You Want an Attorney When Buying or Selling Property</a>",
  popular: true
},
{
  category: "Buying a Home",
...
{
  category: "Closing Timeline & Process",
  question: "What should a buyer bring to closing?",
  answer: "Come prepared with the following: two forms of photo ID (passport, driver's license, or other government-issued ID); certified funds in the form of a cashier's check or confirmed wire transfer for any balance due — personal checks are not accepted for large sums; proof of homeowner's insurance, which your lender requires before funding; flood insurance documentation if the property is in a flood zone; your checkbook for any last-minute small adjustments; any outstanding documents your lender requested (review your Closing Disclosure carefully beforehand); your Social Security number, which is needed for closing paperwork; and a power of attorney if someone will be signing on your behalf, which must be arranged in advance with your attorney. All buyers named on the contract and mortgage must be present unless a power of attorney has been arranged ahead of time. For a complete checklist, see our article: <a href='https://www.statenislandlaw.com/blog/what-to-bring-real-estate-closing-new-york' target='_blank' rel='noopener noreferrer'>www.statenislandlaw.com/blog/what-to-bring-real-estate-closing-new-york</a>"
},
{
  category: "Closing Timeline & Process",
...
// SELLING A HOME
{
  ...
  question: "Why does a home seller need a real estate lawyer?",
  answer: "A seller's lawyer drafts or reviews the contract, advises you on your obligations and required disclosures, responds to buyer requests, helps resolve inspection issues, and prepares you for closing so that you transfer the property correctly and on time.",
  popular: true
},
{
  category: "Selling a Home",
  question: "What are common issues that can delay a closing for sellers?",
  answer: "Common issues include unresolved title problems, lien or payoff issues, inspection disputes, missing documents, and delays with the buyer's mortgage. Having an experienced real estate lawyer helps identify and address these issues early.",
  popular: true
},
{
  category: "Selling a Home",
  question: "Can you work with me if I am selling one home and buying another?",
  answer: "Yes. I regularly represent clients who are both selling and buying, sometimes on the same day. I help coordinate both transactions so that the timing and paperwork work together as smoothly as possible.",
  popular: true
},
{
  category: "Selling a Home",
...
},
{
  ...
  answer: "Try to locate your deed, your owner's policy of title insurance from when you purchased, your survey, mortgage payoff information, and Certificate of Occupancy if available. Having these documents ready speeds up the contract preparation and closing process.<br><br><strong>Learn more:</strong> <a href='/blog/home-selling-checklist'>Home Selling Checklist: Essential Documents and Steps</a>"
},
{
  category: "Selling a Home",
...
},
{
  ...
  answer: "<strong>[NY]</strong> Sellers usually pay transfer taxes (approximately 1.4-2% of sale price in NYC), attorney fee, broker commissions, title company fees, document preparation fees, mortgage payoff, and any agreed credits or repairs. Additional costs may apply for condos and co-ops (HOA fees, flip tax, transfer agent fees). <strong>[NJ]</strong> Transfer taxes are typically paid by seller unless you negotiate otherwise.<br><br><strong>Learn more:</strong> <a href='/blog/typical-closing-costs-new-york-city'>Typical Closing Costs in New York City</a>"
},
{
  category: "Selling a Home",
...
// PROPERTY CONDITION DISCLOSURE
{
  ...
  answer: "<strong>[NY]</strong> Yes, <a href='https://www.nysenate.gov/legislation/laws/RPP/A462' target='_blank' rel='noopener noreferrer'>as of March 2024, sellers must complete the PCDS</a> (NY State Legislature) – despite anything you may have heard, the old $500 opt-out credit was eliminated. The PCDS is a questionnaire about the home's condition (structure, systems, environmental items, flood history/risk). It must be delivered before the buyer signs a binding contract. If you don't know the answer to a question, you must indicate 'unknown' - you cannot skip any questions. <strong>[NJ]</strong> New Jersey has separate seller disclosure requirements, which is very similar. There was never an option to \"opt out\" in New Jersey.<br><br><strong>Learn more:</strong> <a href='/blog/enhanced-property-condition-disclosure-law-2024'>The New Enhanced Property Condition Disclosure Law in New York</a>"
},
{
  category: "Property Condition Disclosure",
...
// CO-OPS & CONDOS
{
  ...
  answer: "<strong>[NY]</strong> With a condo, you own the unit plus a share of common elements. Expect a condo application, fees, a possible right of first refusal, and I'll need to review the offering plan and financials. Mortgage recording tax applies to condo loans.<br><br><strong>Learn more:</strong> <a href='/blog/condos-coops-and-private-homes-key-differences'>Condos, Co-ops, and Private Homes: Key Differences</a>"
},
{
  category: "Co-ops & Condos",
  question: "What's different about buying a co-op?",
  answer: "<strong>[NY]</strong> You're buying shares in a corporation plus a proprietary lease - there's no deed. There's a board package, interview, and financial/policy review. The upside: no mortgage recording tax on co-op loans. The downsides: UCC filings and building transfer fees apply.<br><br><strong>Learn more:</strong> <a href='/blog/condos-coops-and-private-homes-key-differences'>Condos, Co-ops, and Private Homes: Key Differences</a>",
  popular: true
},
{
  category: "Co-ops & Condos",
...
// WIRE FRAUD PREVENTION
{
  ...
  answer: "ALWAYS call to verify wiring instructions before sending any money. <a href='https://www.ic3.gov/Media/Y2021/PSA210521' target='_blank' rel='noopener noreferrer'>Cyber criminals hack email accounts and send emails with fake wiring instructions</a> (FBI Internet Crime Complaint Center) - these emails can be very convincing. Before you initiate any wire transfer, call the title company or my office using a phone number you know is correct (not one from an email) to confirm the wire instructions are accurate.",
  popular: true
},
{
  category: "Wire Fraud Prevention",
...
// TITLE, SURVEY & INSURANCE
{
  ...
  answer: "<a href='https://www.dfs.ny.gov/consumers/mortgages/title_insurance' target='_blank' rel='noopener noreferrer'>Title insurance</a> (NY Department of Financial Services) protects against covered defects like unpaid liens, forged deeds, or recording errors. If you're getting a mortgage, your lender will require you to purchase a lender's policy. Owner's title insurance (which protects you personally) is optional but I strongly recommend it. The premium is a one-time payment at closing.<br><br><strong>Learn more:</strong> <a href='/blog/title-insurance-securing-your-investment'>Title Insurance: Securing Your Investment in Real Estate</a>",
  popular: true
},
{
  category: "Title, Survey & Insurance",
...
{
  category: "Title, Survey & Insurance",
  question: "What does the title search actually look for?",
  answer: "The title search is a comprehensive review of the public record to confirm that the seller has clear, marketable title and that no one else has a valid claim to the property. In Staten Island and New York City, a typical title search examines: the chain of title (the full ownership history, verifying each prior transfer was properly executed and recorded); the mortgage search (confirming all prior mortgages have been satisfied and discharged); a judgment and lien search (identifying any money judgments, tax liens, or mechanic's liens against the seller); a tax search (verifying that property taxes and water/sewer charges are current); a bankruptcy search (confirming the seller has not filed for bankruptcy in a way that could cloud the title); an OFAC search (a federal requirement confirming neither party appears on the Office of Foreign Assets Control list); and municipal searches (checking city agency records for open permits, violations, or unresolved issues with the Department of Buildings, Environmental Control Board, FDNY, and others). The results are compiled into a title commitment, which your attorney reviews before closing. For a step-by-step breakdown, see our article: <a href='https://www.statenislandlaw.com/blog/title-search-process-new-york-home-buyer' target='_blank' rel='noopener noreferrer'>www.statenislandlaw.com/blog/title-search-process-new-york-home-buyer</a>"
},
{
  category: "Title, Survey & Insurance",
  question: "What are Schedule A, B-I, and B-II in a title commitment?",
  answer: "Once the title search is complete, the title company issues a title commitment — a formal promise to insure your title, subject to certain conditions. It is divided into three schedules. Schedule A identifies the property, the parties, the transaction amount, and the type of policy being issued (an owner's policy, a lender's policy, or both). Schedule B-I, titled Requirements, lists conditions that must be satisfied before the title company will issue the final policy — such as payoff of an existing mortgage, discharge of a judgment, or correction of a defect in the chain of title. Schedule B-II, titled Exceptions, lists matters the title policy will not cover, such as easements of record, survey issues, or rights of parties in possession. Your attorney reviews the title commitment carefully to ensure all B-I requirements are resolved before closing and to flag any B-II exceptions that could affect your use or ownership of the property. For more on the title search and commitment process, see our article: <a href='https://www.statenislandlaw.com/blog/title-search-process-new-york-home-buyer' target='_blank' rel='noopener noreferrer'>www.statenislandlaw.com/blog/title-search-process-new-york-home-buyer</a>"
},
{
  category: "Title, Survey & Insurance",
  question: "Do I need a survey?",
  answer: "For houses, a current survey or location drawing helps confirm boundaries, encroachments, and improvements. Condos typically don't need a new survey; co-ops don't involve a deed. Surveys typically cost $800-1,000. Even if your lender says you don't need one, in order for the title company to insure your purchase, unless a recent survey is available, you may need a new one.<br><br><strong>Learn more:</strong> <a href='/blog/importance-of-survey-when-purchasing-real-estate'>The Importance of a Land Survey When Purchasing Real Estate</a>"
},
{
  category: "Title, Survey & Insurance",
...
},
{
  ...
  answer: "These are searches for permits, <a href='https://www.nyc.gov/site/buildings/homeowner/certificate-of-occupancy.page' target='_blank' rel='noopener noreferrer'>certificates of occupancy</a> (NYC Department of Buildings), violations, and open permits. They help ensure the property's legal use matches its actual physical condition and that there are no issues with compliance."
},
{
  category: "Title, Survey & Insurance",
...
},
{
  ...
  answer: "<strong>[NY]</strong> Loans secured by real property (not co-ops) incur a <a href='https://www.nyc.gov/site/finance/taxes/property-mortgage-recording-tax.page' target='_blank' rel='noopener noreferrer'>mortgage recording tax</a> (NYC Department of Finance). Rates are tiered and vary by property type and loan amount. I'll estimate the current amounts for you.<br><br><strong>Learn more:</strong> <a href='/blog/typical-closing-costs-new-york-city'>Typical Closing Costs in New York City</a>"
},
{
  category: "Financing & Mortgages",
...
{
  category: "Taxes & Closing Costs",
  question: "What is a seller concession in NYC, and how is it different from a repair credit?",
  answer: "In New York City, the term \"seller concession\" usually refers to a specific financing arrangement: the purchase price is intentionally inflated — say, by $15,000 — and the seller gives the buyer a credit of that same amount at closing. The buyer's out-of-pocket costs are reduced while the lender funds the higher amount. This differs from how the term is used nationally, where a seller concession often simply means the seller paying some of the buyer's closing costs directly. In NYC, this arrangement must be fully disclosed to the lender, which treats it as an Interested Party Contribution (IPC) subject to Fannie Mae limits — generally 3–9% of the purchase price depending on loan type and down payment. There is also an appraisal risk: if the property doesn't appraise at the inflated price, the deal can fall apart. A repair credit — where the seller gives the buyer money at closing to compensate for defects found during inspection — is a separate concept and is not the same thing. For a full explanation, see our article: <a href='https://www.statenislandlaw.com/blog/seller-concessions-nyc-real-estate' target='_blank' rel='noopener noreferrer'>www.statenislandlaw.com/blog/seller-concessions-nyc-real-estate</a>"
},
{
  category: "Taxes & Closing Costs",
  question: "What transfer taxes apply to NYC residential sales?",
  answer: "<strong>[NY]</strong> <a href='https://www.nyc.gov/site/finance/taxes/real-property-transfer-tax-rptt.page' target='_blank' rel='noopener noreferrer'>New York State and New York City impose transfer taxes</a> (NYC Department of Finance), paid primarily by the seller, at rates tied to price and property type (approximately 1.4-2% of sale price in NYC). Exact rates can change; I'll provide current estimates."
},
{
  category: "Taxes & Closing Costs",
  question: "What is the mansion tax?",
  answer: "<strong>[NY]</strong> A buyer-paid <a href='https://www.tax.ny.gov/pit/property/mansion.htm' target='_blank' rel='noopener noreferrer'>New York State tax that kicks in at $1 million on a graduated scale</a> (NYS Department of Taxation). I'll confirm the applicable bracket and amount for your purchase."
},
{
  category: "Taxes & Closing Costs",
  question: "Can I negotiate the purchase price to avoid or minimize the mansion tax?",
  answer: "Yes — and buyers and sellers often do exactly this when a sale price is near the $1,000,000 threshold. The mansion tax applies to the full purchase price the moment it reaches $1 million. Because it kicks in on the entire amount — not just the portion above $1 million — there is a significant cliff effect just above the threshold. A home at $999,999 carries no mansion tax; a home at $1,000,001 triggers a tax of over $10,000. In practice, buyers sometimes negotiate a price reduction below the threshold, with the seller compensated in another way. Whether this makes sense depends on the specific deal and should be discussed with your attorney. Note that the mansion tax rate increases at multiple tiers above $1 million — at $1.25M, $1.5M, $2M, $3M, $5M, $10M, and $25M — so the same cliff-effect logic applies at each level. For the full rate table and negotiating strategies, see our article: <a href='https://www.statenislandlaw.com/blog/mansion-tax-new-york-home-buyer' target='_blank' rel='noopener noreferrer'>www.statenislandlaw.com/blog/mansion-tax-new-york-home-buyer</a>"
},
{
  category: "Taxes & Closing Costs",
...
},
{
  ...
  answer: "For qualifying investment property sales, a <a href='https://www.irs.gov/newsroom/like-kind-exchanges-real-estate-tax-tips' target='_blank' rel='noopener noreferrer'>like-kind exchange may defer federal and state capital gains taxes</a> (IRS) if strict timelines and rules are met. Engage a qualified intermediary early - this is not something I handle, but I can coordinate with your exchange company or qualified intermediary."
},
{
  category: "Taxes & Closing Costs",
  question: "I'm a foreign seller - what is FIRPTA?",
  answer: "The <a href='https://www.irs.gov/individuals/international-taxpayers/firpta-withholding' target='_blank' rel='noopener noreferrer'>Foreign Investment in Real Property Tax Act</a> (IRS) may require the buyer to withhold a portion of the proceeds at closing unless exemptions apply. Coordinate early with your tax advisors and me."
},
...
// Helper function to strip HTML tags from text (for schema)
...
// Get FAQ URL with anchor
export function getFAQUrl(index: number, absolute = false): string {
  const path = `/faqs#faq-${index}`;
  return absolute ? `https://www.statenislandlaw.com${path}` : path;
}
